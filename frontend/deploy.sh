...
sudo rm -f /tmp/frontend/.gitlab-ci.yml /tmp/frontend/sausage-store-frontend.service /tmp/frontend/deploy.sh
sudo rm -rf /opt/sausage-store/static/*
sudo cp -Rf /tmp/frontend/* /opt/sausage-store/static/ && rm -rf /tmp/frontend/ 
